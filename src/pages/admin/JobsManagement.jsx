        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-6">
          <div className="lg:col-span-8 space-y-4">
            <div className="flex flex-col sm:flex-row items-center gap-3">
              ...
              {loadingStats && !lowonganStats ? (
                <div className="flex-1 w-full h-10 bg-gray-200 rounded-xl animate-pulse"></div>
              ) : (
                <div className="relative flex-1 group w-full">
                  ...
                  <input
                    ...
                    disabled={loading}
                    className={`w-full pl-10 pr-3 py-2 bg-white border border-gray-200 rounded-xl text-sm outline-none transition-all shadow-sm focus:ring-2 focus:ring-primary/20 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                  />
                </div>
              )}
            </div>
